#DON'T FORGET TO USE # TO COMMENT!!!!
# Made by Ayden Bennett
...
# set FPS
    clock.tick(60) # set desired FPS in parenthesis here
# run at 30 FPS when testing and set it back to 60 FPS when playing
